    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<PlaceInfo, PlaceViewHolder>(
            ...
            protected void populateViewHolder(PlaceViewHolder viewHolder, PlaceInfo place, final int position) {
               ...
               // Glide.with(getActivity()).load(place.getFourthimage()).into(viewHolder.mPlaceImage);
                //Glide.with(getActivity()).load(place.getThirdimage()).into(viewHolder.mPlaceImage);
                //Glide.with(getActivity()).load(place.getSecondimage()).into(viewHolder.mPlaceImage);
